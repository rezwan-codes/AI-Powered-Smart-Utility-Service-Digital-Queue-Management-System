...
> = {
  ...
  Waste: {
    ...
    examples: ["Overflowing bin", "Missed collection", "Illegal dumping", "Blocked drain"],
    color: "text-emerald-700",
    bg: "bg-emerald-50",
    border: "border-emerald-200",
    text: "emerald",
  ...
  Streetlight: {
    ...
    examples: ["Light not working", "Flickering", "Pole damaged", "Unsafe area"],
  ...
  Others: {
    Icon: MoreHorizontal,
    title: "Other Utility Issues",
    examples: ["General request", "Service feedback", "Unknown issue", "Other support"],
